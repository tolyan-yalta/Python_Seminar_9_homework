...
Во всех папках заданий созданы файлы `requirements.txt` со списками установленных библиотек/компонент, сами папки добавлены в `.gitignore`, но в архиве приложенном к заданию они есть.